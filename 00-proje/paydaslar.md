# Paydaş Haritası ve İletişim Planı

> **Durum:** Taslak. Asistan bu tabloyu kullanarak "X paydaşını N gündür bilgilendirmedik" hatırlatması yapar.
...
| Ne zaman | Kime | Ne | Format |
|---|---|---|---|
| Sprint sonu | `[paydaş]` | Sprint özeti, demo çıktıları | `04-raporlar/` altında |
| Aylık | `[yönetim]` | İlerleme, risk, karar ihtiyacı | Kısa yönetim özeti |
| Ad-hoc | `[paydaş]` | Kritik gecikme / kapsam değişikliği | Anında, beklemeden |

## Açık paydaş soruları

*(Cevap bekleyen sorular. Asistan bunları takip eder ve hatırlatır.)*

| Tarih | Kim sordu / kime soruldu | Soru | Durum |
|---|---|---|---|
| | | | |

## Bilinen hassasiyetler

*(Kimin neye özellikle dikkat ettiği. Örn: "X yönetici tarih kaymasına çok duyarlı, gecikmeyi erken haber ver.")*
